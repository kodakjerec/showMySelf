...
export default {
  ...
  data: () => ({
    ...
    frameworks: [
      ...
      { title: "Node.js", skilled: 4 },
    ],
    servers: [
      { title: "IIS", skilled: 4 },
      { title: "IBM WebSphere", skilled: 3 },
    ],
    dbs: [
      { title: "MS SQL", skilled: 4 },
      { title: "Store Procedure", skilled: 5 },
      { title: "SQL Server Reporting Services", skilled: 3 },
      { title: "MySQL", skilled: 3 },
    ],
  }),
};
</script>
